...
// Source: github.com/go_todos/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetTodo(arg0 context.Context, arg1 int32) (db.Todo, error) {
	m.ctrl.T.Helper()
...
// ListTodosByUserID mocks base method.
func (m *MockStore) ListTodosByUserID(arg0 context.Context, arg1 db.ListTodosByUserIDParams) ([]db.Todo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTodosByUserID", arg0, arg1)
	ret0, _ := ret[0].([]db.Todo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTodosByUserID indicates an expected call of ListTodosByUserID.
func (mr *MockStoreMockRecorder) ListTodosByUserID(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTodosByUserID", reflect.TypeOf((*MockStore)(nil).ListTodosByUserID), arg0, arg1)
}
